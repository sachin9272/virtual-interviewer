...
export default function Page() {
  return(
    ...
    <aside className="hidden lg:flex w-full lg:w-1/2 bg-gray-100 items-center justify-center">
      <img
        src="https://media.licdn.com/dms/image/v2/D4D12AQHARvg6qKGfoA/article-cover_image-shrink_720_1280/B4DZT4yvgtGcAM-/0/1739340840975?e=2147483647&v=beta&t=f_WLxXeJABjFMit5m4HUo3HrcLQaEb3YGkXqzAO3bZ8"
        alt="Welcome visual"
